...
${no_of_items_locator_mini_cart}                 xpath:(//span[@class='js-minicart-title-qty minicart-title-qty'])[1]
${product_primary_title_locator_mini_cart}       xpath://div[@class='line-item-header line-item-primary-title']/a
${product_secondary_title_locator_mini_cart}     xpath://div[@class='line-item-header line-item-secondary-title ']/a
${item_price_locator_mini_cart}                  xpath:(//div[contains(@class,'line-item-total-price-amount')])[1]
${item_size_locator_mini_cart}                   xpath:(//div[@class='line-item-attributes']/span[2])[1]
